...
import es.in2.verifier.domain.model.dto.credentials.employee.CredentialSubjectLCEmployee;
import es.in2.verifier.domain.model.dto.credentials.employee.LEARCredentialEmployee;
import es.in2.verifier.domain.model.dto.credentials.employee.MandateLCEmployee;
import es.in2.verifier.domain.model.dto.credentials.employee.MandateeLCEmployee;
import es.in2.verifier.domain.model.dto.credentials.machine.CredentialSubjectLCMachine;
import es.in2.verifier.domain.model.dto.credentials.machine.LEARCredentialMachine;
import es.in2.verifier.domain.model.dto.credentials.machine.MandateLCMachine;
import es.in2.verifier.domain.model.dto.credentials.machine.MandateeLCMachine;
...
class CustomAuthenticationProviderTest {
    ...
    void authenticate_validCodeGrant_success_With_LEARCredentialEmployee() {
        ...
        when(applicationConfig.getAccessTokenExpiration()).thenReturn(3600L);
        ...
        when(cryptoConfig.getECKey().getKeyID()).thenReturn("mock-key-id");
