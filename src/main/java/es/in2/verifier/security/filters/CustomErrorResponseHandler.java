...
import static es.in2.verifier.util.Constants.INVALID_CLIENT_AUTHENTICATION;
import static es.in2.verifier.util.Constants.REQUIRED_EXTERNAL_USER_AUTHENTICATION;
